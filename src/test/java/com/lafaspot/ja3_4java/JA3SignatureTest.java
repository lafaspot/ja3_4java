...
public class JA3SignatureTest {
    ...
    public void testOpenSSL_SSL3() throws Exception {
        Assert.assertEquals(
                ...
                JA3Signature.ja3Signature(ByteBuffer.wrap(openSSL_SSL3)));
    }
    ...
    public void testOpenSSL_TLS1() throws Exception {
        Assert.assertEquals(
                ...
                JA3Signature.ja3Signature(ByteBuffer.wrap(openSSL_TLS1)));
    }
    ...
    public void testOpenSSL_TLS1_1() throws Exception {
        Assert.assertEquals(
                ...
                JA3Signature.ja3Signature(ByteBuffer.wrap(openSSL_TLS1_1)));
    }
    ...
    public void testOpenSSL_TLS1_2() throws Exception {
        Assert.assertEquals(
                ...
                JA3Signature.ja3Signature(ByteBuffer.wrap(openSSL_TLS1_2)));
    }
    ...
    public void testNotHandshake() throws Exception {
        ...
        packet[0] = 21;
        Assert.assertNull(JA3Signature.ja3Signature(ByteBuffer.wrap(packet)));
    }
    ...
    public void testGreaseCipher() throws Exception {
        ...
        Assert.assertEquals(
                ...
                JA3Signature.ja3Signature(ByteBuffer.wrap(packet)));
    }
